...
import { GUISMI } from './helpers/config.mjs';
...
Hooks.once('init', function () {
  ...
  CONFIG.Actor.dataModels = {
    character: models.GuismiCharacter,
    npc: models.GuismiNPC
  }
  CONFIG.Item.documentClass = GuismiItem;
  CONFIG.Item.dataModels = {
    item: models.GuismiItem,
    feature: models.GuismiFeature,
    spell: models.GuismiSpell
  }
  ...
  Actors.registerSheet('guismi', GuismiActorSheet, {
    makeDefault: true,
    label: 'GUISMI.SheetLabels.Actor',
  });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.guismi.rollItemMacro("${data.uuid}");`;
